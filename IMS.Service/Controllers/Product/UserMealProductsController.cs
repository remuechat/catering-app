...
namespace IMS.Service.Controllers.Product
{
    ...
    [ApiController]
    public class UserMealProductsController : ControllerBase
    {
        private readonly AppDbContext _context;

        public UserMealProductsController(AppDbContext context)
        {
            _context = context;
        }

        // GET: api/UserMealProducts
        [HttpGet]
